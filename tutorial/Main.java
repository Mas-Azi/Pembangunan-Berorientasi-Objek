...
// Kemudian memakai library BufferReader, FileReader, StringTokenizer, IoException, dan Scanner
...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        while(lanjut) {
            ...
            System.out.print("\n\nPilihan anda: ");
            pilihanUser = terminaluser.next();

            //membuat pilihan dengan menggunakan switch case
            switch (pilihanUser) {
                case "1":
                    System.out.println("\n=================");
    ...
    // membuat method atau fungsi menampilkan data dengan IOException untuk menafsirkan input dan output yang salah
    private static void tampilkanData() throws IOException{
        ...
        try{
            fileInput = new FileReader("D:\\Project-java\\Pertemuan 12\\src\\com\\tutorial\\database.txt");
